...
<body onresize="updateResize()">
    <div class="container azue-header">
        <div class="jumbotron azue-header" style="background-image: url('autism.png'); height: 126px; position: relative; padding-top: 10px;">
            <a href="/">
                <div class="wheel">
                    <wheel></wheel>
                </div>
                        ...
                        <div id="divControlsGlobal">
                            <div class="row">
                                <div class="col-lg-6" id="col-global-1">
                                    <p>
                                        <asp:PlaceHolder ID="GlobalPlaceHolder1" runat="server"></asp:PlaceHolder>
                                    </p>
                                </div>
                                <div class="col-lg-6" id="col-global-2">
                                    <p>
                                        <asp:PlaceHolder ID="GlobalPlaceHolder2" runat="server"></asp:PlaceHolder>
                                    </p>
                                </div>
                            </div>
                        </div>
